...
import com.performance.module_4_30.*
import com.performance.module_3_24.Feature24_5
import com.performance.module_3_28.Feature28_5


            @OptIn(ExperimentalCoroutinesApi::class)
            class Feature30_1Test {
                    private lateinit var repository0: Feature24_5
        private lateinit var repository1: Feature28_5

    private lateinit var viewModel: Feature30_1

    @Before
    fun setup() {
       repository0 = Feature24_5()
        repository1 = Feature28_5()
        viewModel = Feature30_1(
            repository0,
            repository1
        )
    }
